      ...
      <div className="bg-scout-green/5 border-2 border-scout-green/20 rounded-3xl p-8 mb-12 flex flex-col md:flex-row items-center gap-8">
        ...
        <div>
          ...
          <p className="text-muted font-bold text-lg">
            LodgeLink was designed from the ground up to respect the privacy of
            scouts and scouters. Your data never leaves your device.
          </p>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 text-foreground">
        <section>
          ...
          <div className="space-y-4 text-muted font-medium">
            <p>
              When you import a CSV or create an attendee, that information is
              stored in your browser's <strong>IndexedDB</strong> using
              Dexie.js. This is a local database that stays on your physical
              computer.
            </p>
            <p>
              We do not have a central database, and we do not have access to
              your event records, attendee lists, or health form status.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted font-medium">
            <p>
              We do not use Google Analytics, Facebook Pixels, or any other
              third-party tracking scripts. We don't want to know how you use
              the app—we just want it to work for you.
            </p>
            <p>
        ...
        <section>
          ...
          <div className="space-y-4 text-muted font-medium">
            <p>
              We allow you to track sensitive fields like{" "}
              <strong>Health Form Status</strong>. Because this data is stored
              locally, it is your responsibility to secure your device and
              ensure you are following Scouting America's safeguarding youth and digital privacy
              guidelines.
            </p>
          </div>
        </section>
