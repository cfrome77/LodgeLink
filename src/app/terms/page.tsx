      ...
      <div className="prose prose-lg dark:prose-invert text-foreground space-y-12">
        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            ...
            <h2 className="text-2xl font-black uppercase tracking-tight m-0">2. User Responsibilities</h2>
          </div>
          <p className="text-muted font-medium">
            You are responsible for:
          </p>
          <ul className="text-muted font-medium list-disc pl-6 space-y-2">
            <li>Maintaining the confidentiality of any data you import into the application.</li>
            <li>Ensuring that your use of the application complies with all Boy Scouts of America (BSA) and Order of the Arrow (OA) policies, including Youth Protection Guidelines.</li>
            <li>Verifying the accuracy of data before importing it into LodgeMaster or other official systems.</li>
          </ul>
        </section>
